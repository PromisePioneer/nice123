@extends('layouts.app')
@section('content')
    <div class="col-xl-12" x-data="permissionData">
        <div class="card card-xl-stretch mb-5 mb-xl-8">
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Data Permission</span>
                </h3>
            ...
            <div class="card-body py-3">
                    @include('pages.user.permission.components.create')
                    @include('pages.user.permission.components.edit')
                    <div class="float-end">
                    ...
                    <table class="table table-striped gy-7 gs-7">
                        ...
                        <template x-if="!isLoading && permission.data?.length === 0">
                            <tr>
                                <td colspan="9">
                        ...
                        <template x-for="(row,index) in permission?.data">
                            <tr>
...
@endsection
@push('js')
    @include('pages.user.permission.script')
@endpush
