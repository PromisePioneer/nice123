@extends('layouts.app')
@section('content')
    <div class="row" x-data="createData">
        <div class="col-12">
            <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row mb-6">
                                ...
                                <div class="col-lg-4 fv-row">
                                    <input type="text" name="name" class="form-control form-control-lg form-control-solid" placeholder="Nama" value="" />
                                </div>
                            </div>
                            <div class="form-group row mb-6">
                                <label class="col-lg-2 col-form-label required fw-bold fs-6">Email</label>
                                <div class="col-lg-10 fv-row">
                                    <input type="email" name="email" id="error" class="form-control form-control-lg form-control-solid" placeholder="Email"/>
                                </div>
                            </div>
                            <div class="form-group row mb-6">
...
@endsection
@push('js')
    @include('pages.user.user.components.script.create')
@endpush
