    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-create" @submit.prevent="saveBarang()">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-10">
                        ...
                        <div class="col-md-6">
                            <div class="mb-10">
                                ...
                                <input type="number" class="form-control form-control-solid" name="harga_modal"  placeholder="Harga"/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-10">
                                <label class="required form-label">Harga Jual</label>
                                <input type="number" class="form-control form-control-solid" name="harga_jual"  placeholder="Harga"/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-10">
