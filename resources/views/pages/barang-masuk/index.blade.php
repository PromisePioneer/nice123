...
@section('content')
    ...
    <div class="col-xl-12" x-data="barangMasukData">
                ...
                <table class="table table-striped table-bordered gy-7 gs-7">
                    ...
                    <template x-for="(row,index) in barangMasuk?.data">
                        <tr>
                            ...
                            <td  x-text="currency(row.barangs.harga_modal)"></td>
        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-body py-3">
                @include('pages.barang-masuk.record-barang-components.create')
                @include('pages.barang-masuk.record-barang-components.edit')
                <div class="float-end">
                ...
                <table class="table table-striped gy-7 gs-7">
                    ...
                    <template x-for="(row,index) in barangData?.data">
                        <tr>
                            ...
                            <td x-text="currency(row.harga_modal)"></td>
