@extends('layouts.app')
@section('content')
    <div class="col-xl-12" x-data="barangData">
        <div class="card card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-body py-3">
                ...
                <table class="table table-striped gy-7 gs-7">
                    ...
                    <template x-if="!isLoading && barang.data?.length === 0">
                        <tr>
                            <td colspan="9">
                    ...
                    <template x-for="(row,index) in barang?.data">
                        <tr>
...
@endsection
@push('js')
    @include('pages.master.barang.script')
@endpush
